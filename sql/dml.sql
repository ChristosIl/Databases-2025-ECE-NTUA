    ...
    VALUES
    ('Main Stage', 'Biggest stage of the fest', 110, 'Lights, sound system, pyrotechnics', 'http://dummyimage.com/400x100.png', 'desc'),
    ('Electric Grove', 'High-tech stage with panoramic LED screens.', 100, 'Lights, lasers, subwoofers', 'http://dummyimage.com/206x100.png', 'Electric Grove setup with lights, lasers, subwoofers.'),
